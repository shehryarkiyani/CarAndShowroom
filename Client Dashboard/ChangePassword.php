          ...
          <ul class="navbar-nav">
                    ...
                    <li class="nav-item">
                        ...
                        <ul class="navbar-nav OrderList">
                            <li class="nav-item">
                                <a href="PendingPayment.php" role="button" onclick="PendingPayment()" class="nav-link"> &nbsp; &nbsp;<i class="fa fa-pencil" aria-hidden="true"></i> My Cart</a>
                            </li>
                            <li class="nav-item">
            ...
            <div class="Accounts" >
            <span class="alert alert-success" id="Record">Password Changed Successfully</span>
            <span class="alert alert-danger" id="err">Previous password incorrect</span>
                <div class="h1" >Change Password</div>
                <form class="form" method="POST" id="Form1" enctype="multipart/form-data">
                    <div class="form-group" >
                        <div class="d-flex flex-column">
                            
                            <label for="Model">Enter Previous Password</label>
                      
                            <input type="text" class="form-control Field" name="prev" placeholder="Enter Previous Password">
                           
                            <label for="Model">Enter New Password</label>
                            
                            <input type="text" class="form-control Field" id="Pass" name="pass" placeholder="Enter New Password" onkeyup="validate(this)" pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}" required>
                            <p id="Opass">Must contain at least one(number,uppercase and lowercase letter),and at least 8 or more characters</p>
